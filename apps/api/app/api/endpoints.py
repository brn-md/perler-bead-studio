...
async def process_image_endpoint(
    ...
    bg_tolerance: Optional[float] = Form(18.0, description="Perimeter background Delta-E color tolerance (0-100)"),
    ...
    try:
        ...
        result = process_pixel_art(
            ...
            background_mode=background_mode or "cutout",
            grid_mode=grid_mode or "auto",
            bg_tolerance=float(bg_tolerance) if bg_tolerance is not None else 18.0,
